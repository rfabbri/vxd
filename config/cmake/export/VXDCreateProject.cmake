...
set(VXD_CMAKE_DOXYGEN_DIR  ${VXD_ROOT_SOURCE_DIR}/config/cmake/doxygen)

get_property(VXDTargets_MODULES GLOBAL PROPERTY VXDTargets_MODULES)

set(VXD_CONFIG_CMAKE_DIR "share/vxd/cmake")
...
if(VXDTargets_MODULES)
  ...
  install(EXPORT ${VXD_INSTALL_EXPORT_NAME} DESTINATION ${VXD_CONFIG_CMAKE_DIR}
          COMPONENT Development)
endif()

# Create the VXDConfig.cmake file for the build tree.
configure_file(${VXD_CMAKE_DIR}/VXDConfig.cmake.in
               ${PROJECT_BINARY_DIR}/VXDConfig.cmake @ONLY)

configure_file(${VXD_CMAKE_DIR}/VXDConfig_export.cmake.in
               ${PROJECT_BINARY_DIR}/config/cmake/export/VXDConfig.cmake
               @ONLY)

install(FILES
  ${PROJECT_BINARY_DIR}/config/cmake/export/VXDConfig.cmake
  ${VXD_CMAKE_DIR}/VXDStandardOptions.cmake
  ${VXD_CMAKE_DIR}/UseVXD.cmake
  DESTINATION ${VXD_CONFIG_CMAKE_DIR}
)
