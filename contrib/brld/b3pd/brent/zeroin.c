...
*******************************************************************************
 * Modifications:
 * 05/14/2007 Nhon Trinh      Added argument for maximum number of iterations
...
double zeroin(ax,bx,f,tol, max_iter)    /* An estimate to the root  */
...
int max_iter;       /* Maximum number of iterations */
{
  ...
  for(i=0; i<max_iter; ++i)    /* Main iteration loop  */
  {
