...
b_read_vpgld(vsl_b_istream &is, vpgl_calibration_matrix<T>* tis);

//: Binary save self to stream.
template <class T> void 
b_write_vpgld(vsl_b_ostream &os, const vpgl_calibration_matrix<T>* tis);
...
//: Binary load self from stream.
template <class T> void 
b_read_vpgld(vsl_b_istream &is, vpgl_perspective_camera<T>* tis);

//: Binary save self to stream.
template <class T> void 
b_write_vpgld(vsl_b_ostream &os, const vpgl_perspective_camera<T>* tis);
...
vpgld_cast_to_perspective_camera(const vpgl_proj_camera<double> *cam)
{
