...
void borld_category_info::set_color(vil_rgb<vxl_byte> c)
{
  color_ = c;
}
...
void borld_category_info_set::add_category(borld_category_info_sptr c) 
{ 
  cats_.push_back(c); 
}
...
void vsl_b_read(vsl_b_istream& is, borld_category_info_set* ph)
{
  ...
  if (not_null_ptr)
  {
    ph = new borld_category_info_set();
    vsl_b_read(is, *ph);
  }
  else
    ph = 0;
