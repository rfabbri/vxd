...
void buld_exp_stat::print_stats(vcl_ofstream& of)
{
...
void buld_exp_stat::read_stats(vcl_ifstream& ifs)
{
  vul_awk awk(ifs);
  for( ; awk ; ++awk ) {
...
void buld_exp_stat::print_stats(vcl_string name, vcl_ofstream& of, bool print_FN)
{
  if (print_FN)
...
{
  vcl_cerr << "vsl_b_write() -- Binary io, NOT IMPLEMENTED, signatures defined to use buld_exp_stat as a brdb_value\n";
  return;
}

void vsl_b_read(vsl_b_istream & is, buld_exp_stat &ph)
{
  vcl_cerr << "vsl_b_read() -- Binary io, NOT IMPLEMENTED, signatures defined to use buld_exp_stat as a brdb_value\n";
  return;
}
