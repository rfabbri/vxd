// This is bsold_soview2D_circ_arc.h
#ifndef bsold_soview2D_circ_arc_h_
#define bsold_soview2D_circ_arc_h_
//--------------------------------------------------------------------------------
//:
// \file
...
class bsold_soview2D_circ_arc : public bgui_vsol_soview2D
{
 public:
  //: Constructor - creates a view of a given bsold_circ_arc_2d
  bsold_soview2D_circ_arc( bsold_circ_arc_2d_sptr const & circ_arc);
  ...
  bsold_circ_arc_2d_sptr sptr() const;
