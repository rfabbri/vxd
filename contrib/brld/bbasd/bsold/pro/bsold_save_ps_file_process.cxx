// This is bbasd/bsold/pro/bsold_save_ps_file_process.cxx

//:
// \file

#include "bsold_save_ps_file_process.h"
...
bpro1_process*
bsold_save_ps_file_process::clone() const
{
  return new bsold_save_ps_file_process(*this);
}
...
int bsold_save_ps_file_process::
input_frames()
{
  return 1;
}
...
bool bsold_save_ps_file_process::
execute()
{
