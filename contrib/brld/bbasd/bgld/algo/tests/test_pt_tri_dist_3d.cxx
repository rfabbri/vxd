...
MAIN( test_pt_tri_dist_3d )
{
  ...
  //A complete test of bgld_pt_fpt_tri ()
  vgl_point_3d<double> F; 
  double t, u, v; 
  bool result = bgld_pt_fpt_tri (P, A, B, C, F, t, u, v);
  ...
  P.set (1.0, 1.0, 0.0);
  result = bgld_pt_fpt_tri (P, A, B, C, F, t, u, v);
  TEST("Foot point outside ABC", result==false, true);

  //A complete test of bgld_pt_tri_dist_3d ()
  A.set (0.0, 0.0, 0.0);   
  B.set (1.0, 0.0, 0.0);   
  C.set (0.0, 1.0, 0.0);  
  ...
  //P inside ABC
  P.set (0.3, 0.5, 0.2);
  t = bgld_pt_tri_dist_3d (P, A, B, C, G);
