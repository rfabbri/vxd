...
double bgld_poly_curve_line::length() const 
{
  return len_;
}

vgl_point_2d<double> bgld_poly_curve_line::point_at_length(double l) const
{
  double s = l/len_;
  return point_at(s);
}
...
vgl_vector_2d<double> bgld_poly_curve_line::tangent_at_length(double l) const
{
  double s = l/len_;
  return tangent_at(s);
}
...
double bgld_poly_curve_line::curvature_at_length(double l) const
{
  double s = l/len_;
...
double bgld_poly_curve_line::tangent_angle_at_length(double l) const
{
  double s = l/len_;
